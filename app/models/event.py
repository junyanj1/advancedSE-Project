...
class Event:
    def __init__(self, user_id, event_name, event_description, event_location, event_start_time, event_end_time, attendee_limit, event_id=None):
        if event_id is None:
            self.generate_id()
        else:
    ...
    def generate_id(self):
        self.event_id = re.sub("[^0-9a-zA-Z]+", "", str(base64.b64encode(uuid.uuid4().bytes)))
